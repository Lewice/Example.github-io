...
<head>
  ...
  <script>
    ...
    var discordWebhookURL = 'https://discord.com/api/webhooks/1172383685815844865/jacQKT7mcO9K093AmpbpqETSak8qlCRXzcGQs-tb9RXqMoEFmY-uQ10RaWahQgKutZ9V';
...
<body style="background-color:cyan;">
	<img src="1698785119340.png" alt="Company Logo!">
  ...
  <div>
    ...
    <label for="ColinChoice">Burger - $300</label>
    <input type="number" value="1" min="1">
  </div>
  
  <div>
    <input type="checkbox" id="JudysChoice" value="400">
    <label for="JudysChoice">hotdog - $400</label>
    <input type="number" value="1" min="1">
  </div>
  
  <div>
    <input type="checkbox" id="Velmachoice" value="400$">
    <label for="Velmachoice">pizza - $400</label>
    <input type="number" value="1" min="1">
  </div>
  
  <div>
    <input type="checkbox" id="Davechoice" value="400$">
    <label for="Davechoice">Burrito - $400</label>
    <input type="number" value="1" min="1">
  </div>
